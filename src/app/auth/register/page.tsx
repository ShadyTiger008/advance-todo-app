  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <div className="from-primary/20 via-primary/5 to-background relative hidden overflow-hidden bg-gradient-to-br md:flex md:w-1/2">
        ...
        <div className="bg-primary/20 absolute top-1/4 right-1/4 h-64 w-64 rounded-full blur-3xl" />
        <div className="bg-secondary/20 absolute bottom-1/3 left-1/3 h-64 w-64 rounded-full blur-3xl" />
          ...
          >
            <div className="bg-card/80 border-border/50 mb-8 rounded-xl border p-6 shadow-lg backdrop-blur-sm">
              <div className="mb-4 flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold">TaskFlow Dashboard</h3>
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="bg-muted-foreground/20 h-16 rounded-md" />
                <div className="bg-muted-foreground/20 h-16 rounded-md" />
                <div className="bg-muted-foreground/20 h-16 rounded-md" />
                <div className="bg-muted-foreground/20 h-16 rounded-md" />
                <div className="bg-muted-foreground/20 h-16 rounded-md" />
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Create your TaskFlow account and join thousands of teams who
